...
<!-- end header mobile  -->
   ...
   <section class="w-full flex justify-center bg-color5 h-auto" id="about">
    ...
    <section class="w-full flex justify-center bg-color7 py-8" id="tour">
        <div class="w-full container 2xl:px-36">
                <div>
                        ...
                        <div class="flex flex-wrap md:justify-between gap-10 px-6 xl:px-0 py-8 lg:px-3 ">
                                ...
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000 ">
                                        <div class="w-[100%] h-[100%] bottom-photo absolute bg-white flex flex-col justify-center px-5">
                                                <p class="text-3xl text-color3 capitalize font-secondary">Cancun</p>
                                                <p class="text-color1 mb-4">$4.300 / per persons</p>
                                                <p class="text-color6">Why is Cancun a top destination for travelers? Cancun's beaches are well-known for their white sand and pristine blue waters—perfect for sunbathing, surfing, and watersports. Fantastic nightlife with popular clubs like Hard Rock Café, The City, and Coco Bongo. Opportunities to take in Mexico's rich history, with Mayan ruins just a short trip away</p>
                                                <div class="flex flex-wrap my-4">
                                                        <div class="w-[50%] flex"><i class="bi bi-clock text-color4"></i><p class="text-color6 ms-2">6 Days</p></div>
                                                        <div class="w-[50%] flex"><i class="bi bi-geo-alt text-color4"></i><p class="text-color6 ms-2">Mexico</p></div>
                                        ...
                                        <img src="img/cancun Mexico.jpg" alt="" class="w-[100%] h-[100%] object-cover brightness-75 absolute">
                                        <p class="absolute uppercase text-white bg-color3 px-4 py-1 right-1 top-12 rotate-[-90deg] ">Mexico</p>
                                        <figcaption class="absolute text-white bottom-8 right-10 fig">
                                                <p class="capitalize font-secondary text-3xl">Cancun Tours</p>
                                                <p class="text-right">$4.300 / per persons</p>
                                        </figcaption>
                                </figure>
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000">
                                        <div class="w-[100%] h-[100%] bottom-photo absolute bg-white flex flex-col justify-center px-5">
                                                <p class="text-3xl text-color3 capitalize font-secondary">Cape Town</p>
                                                <p class="text-color1 mb-4">$1.800 / per persons</p>
                                                <p class="text-color6"> Why is Cape Town a top destination for travelers? Being home to iconic mountain ranges, stunning natural wonders, thrilling landscapes and ocean vistas, Cape Town offers no shortage of adventures. Known as the adventure capital of South Africa, the lifestyle of locals and visitors alike centres around the outdoors and an active lifestyle.</p>
                                                <div class="flex flex-wrap my-4">
                                                        <div class="w-[50%] flex"><i class="bi bi-clock text-color4"></i><p class="text-color6 ms-2">10 Days</p></div>
                                                        <div class="w-[50%] flex"><i class="bi bi-geo-alt text-color4"></i><p class="text-color6 ms-2">South Africa</p></div>
                                                        <div class="w-[50%] flex"><i class="bi bi-person text-color4"></i></i><p class="text-color6 ms-2">6+</p></div>
                                                        <div class="w-[50%] flex"><i class="bi bi-emoji-smile text-color4"></i></i><p class="text-color6 ms-2">9.5 Superb</p></div>
                                                </div>
                                                <a href="https://wa.me/+2349042153922" class="underline decoration-color1 text-color6 flex mb-2">Tour details</a>
                                        </div>
                                        <img src="img/Cape-Town-Aerial-view.jpg" alt="" class="w-[100%] h-[100%] object-cover brightness-75 absolute">
                                        <p class="absolute uppercase text-white bg-color3 px-4 py-1 right-1 top-12 rotate-[-90deg] ">S. Africa</p>
                                        <figcaption class="absolute text-white bottom-8 right-10 fig">
                                                <p class="capitalize font-secondary text-3xl">Cape Town</p>
                                                <p class="text-right">$1.800 / per persons</p>
                                        </figcaption>
                                </figure>
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000 ">
                                        <div class="w-[100%] h-[100%] bottom-photo absolute bg-white flex flex-col justify-center px-5">
                                                <p class="text-3xl text-color3 capitalize font-secondary">Athens</p>
                                                <p class="text-color1 mb-4">$2.500 / per persons</p>
                                                <p class="text-color6">Greece is one of the best destinations in Europe for travelers. With delicious food, famous hospitality, historic sites, beautiful views and mild weather. Athens is Greece's capital city. With its tall buildings and contemporary shops, is the first European city when approached from the Middle East.</p>
                                                <div class="flex flex-wrap my-4">
                                                        <div class="w-[50%] flex"><i class="bi bi-clock text-color4"></i><p class="text-color6 ms-2">10 Days</p></div>
                                        ...
                                        <img src="img/R.jfif" alt="" class="w-[100%] h-[100%] object-cover brightness-75 absolute">
                                        <p class="absolute uppercase text-white bg-color3 px-4 py-1 right-[-15px] top-12 rotate-[-90deg] ">greece</p>
                                        <figcaption class="absolute text-white bottom-8 right-10 fig">
                                                <p class="capitalize font-secondary text-3xl">Athens Tours</p>
                                                <p class="text-right">$2.500 / per persons</p>
                                        </figcaption>
                                </figure>
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000 ">
                                        <div class="w-[100%] h-[100%] bottom-photo absolute bg-white flex flex-col justify-center px-5">
                                                <p class="text-3xl text-color3 capitalize font-secondary">Toronto</p>
...
Many of the best cities to visit in Canada are gateways to magnificent wilderness areas and exciting recreational facilities, with some of the best resorts in the world.</p>
                                        ...
                                        <img src="img/toronto_condo_skyline1600X1000_55.jpg" alt="" class="w-[100%] h-[100%] object-cover brightness-75 absolute">
                                        <p class="absolute uppercase text-white bg-color3 px-4 py-1 right-[-15px] top-12 rotate-[-90deg] ">canada</p>
                                        <figcaption class="absolute text-white bottom-8 right-10 fig">
                                                <p class="capitalize font-secondary text-3xl">Toronto tours</p>
                                                <p class="text-right">$2.000 / per persons</p>
                                        </figcaption>
                                </figure>
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000 ">
                                        <div class="w-[100%] h-[100%] bottom-photo absolute bg-white flex flex-col justify-center px-5">
                                        ...
                                        <figcaption class="absolute text-white bottom-8 right-10 fig">
                                                <p class="capitalize font-secondary text-3xl">dubai Tours</p>
                                                <p class="text-right">$2.000 / per persons</p>
                                        </figcaption>
                                </figure>
                        </div>
    ...
    <section class="w-full flex justify-center bg-color7 lg:h-[800px]" id=destination>
        <div class="w-full container 2xl:px-36 py-16 bg-color7 ">
                ...
                <div class="w-full flex lg:relative py-10 flex-wrap lg:px-3 xl:px-0 px-6">
                        ...
                        <div class="w-full lg:w-[50%] lg:absolute lg:h-[400px] bg-map bg-no-repeat bg-center z-10 lg:right-0 xl:top-[170%] md:top-20 px-10 py-16 bg-white" >
                                ...
                                <p class="text-color6">Spicy Team will guide you to choose a country with good tourism. Italy is one of such country with Colosseum, Amphitheatre in Rome.</p>
                                <div class=" flex flex-wrap py-4 ">
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Rome</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Siena</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Venice</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Milan</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Bologna</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Palermo</p></div>
                                        
                                </div>
                                <a href="https://www.getyourguide.com/colosseum-l2619/" target="_blank" class=" flex py-4 relative  text-color1 before:content-[''] before:h-[1px] before:absolute before:w-[100%] before:bg-color6 before:bg-opacity-50 before:top-0"><p>Learn more about Colosseum</p><i class="bi bi-arrow-right"></i></a>
    ...
    <section class="w-full flex justify-center bg-color3 py-8 h-auto" id="blog">
        <div class="w-full container 2xl:px-36 h-auto">
                <div>
                        <p class="text-color4 px-5">TRAVEL BLOG <a href="https://www.facebook.com/profile.php?id=61559042624426&mibextid=ZbWKwL" class="text-color6"><i class="bi bi-facebook text-white p-3 rounded-[50%]"></i>click for more</a> </p>
                        ...
                        <div class="flex flex-wrap justify-center xl:justify-between gap-10 px-6 xl:px-0 py-8 lg:px-3 ">
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                   <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative">     <img src="img/White House_Washington D.C.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                        ...
                                        <figcaption class=" absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-8 group-hover:bottom-10 transition-all duration-1000 ">
                                                <p class="uppercase text-color4">Travel</p>
                                                <p class="capitalize text-color3 font-secondary text-xl">Washington D.C <br> USA</p>
                                        </figcaption>
                                </figure>
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/Grasse, French Riviera.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             <div class="absolute uppercase text-white bg-color1 px-2 left-3 top-12 flex flex-col items-center "><p></p><p class="font-bold"></p></div>
                                             <figcaption class=" absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-3 group-hover:bottom-10 transition-all duration-1000 ">
                                                     <p class="uppercase text-color4">Tour</p>
                                                     <p class="capitalize text-color3 font-secondary text-xl">Grasse <br> French Riveria</p>
                                             </figcaption>
                                     </figure>
                                     <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/TimesSquare_Newyork.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             <div class="absolute uppercase text-white bg-color1 px-2 left-3 top-12 flex flex-col items-center "><p></p><p class="font-bold"></p></div>
                                             <figcaption class=" absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-5 group-hover:bottom-10 transition-all duration-1000 ">
                                                     <p class="uppercase text-color4">Vacation</p>
                                                     <p class="capitalize text-color3 font-secondary text-xl">New York City<br> USA </p>
                                             </figcaption>
                                     </figure>
                                     <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/Vienna_AUSTRIA.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             ...
                                             <figcaption class=" absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-5 group-hover:bottom-10 transition-all duration-1000 ">
                                                     <p class="uppercase text-color4">Travel</p>
                                                     <p class="capitalize text-color3 font-secondary text-xl">Vienna<br> Austria, Europe </p>
                                             </figcaption>
                                     </figure>
                                     <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/Nice_French_Riviera.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             ...
                                             <figcaption class=" absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-5 group-hover:bottom-10 transition-all duration-1000 ">
                                                     <p class="uppercase text-color4">Tour</p>
                                                     <p class="capitalize text-color3 font-secondary text-xl">Nice<br> French Riviera </p>
                                             </figcaption>
                                     </figure>
                                     <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/Bratislava_SLOVAKIA.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             ...
                                             <figcaption class=" absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-5 group-hover:bottom-10 transition-all duration-1000 ">
                                                     <p class="uppercase text-color4">Vacation</p>
                                                     <p class="capitalize text-color3 font-secondary text-xl">Bratislava<br> Slovakia, Europe </p>
                                             </figcaption>
                                     </figure>
                                     ...
                                     <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/pix5.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             ...
                                             <figcaption class="absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-5 group-hover:bottom-10 transition-all duration-1000 ">
                                                     ...
                                                     <p class="capitalize text-color3 font-secondary text-xl">Johannesburg<br> South Africa </p>
                                             </figcaption>
                                     </figure>
                                     ...
                                     <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/New_York.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             ...
                                             <figcaption class=" absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-5 group-hover:bottom-10 transition-all duration-1000 ">
                                                     <p class="uppercase text-color4">Vacation</p>
                                                     <p class="capitalize text-color3 font-secondary text-xl">Times Square<br> NYC, USA </p>
                                             </figcaption>
                                     </figure>
                                     ...
                                     <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative  transition-all duration-1000  group mb-20   ">   
                                        <div class="w-[100%] h-[100%] overflow-hidden group transition-all duration-1000 relative"> <img src="img/Rome_Italy.jpeg" alt="" class="w-[100%] h-[100%] object-cover group-hover:brightness-75 group-hover:scale-[1.2] absolute transition-all duration-1000"></div>
                                             ...
                                             <figcaption class="absolute h-[100px] w-[60%]  bg-white bottom-[-80px]  left-[8%] flex flex-col justify-center px-5 group-hover:bottom-10 transition-all duration-1000 ">
                                                     <p class="uppercase text-color4">Hotel</p>
                                                     <p class="capitalize text-color3 font-secondary text-xl">Rome<br> Italy, Europe </p>
                                             </figcaption>
                                     </figure>
                        </div>
                </div>
    ...
    <section class="w-full flex justify-center h-auto  bg-color3" id="contact">
        <footer class="w-full container h-auto flex flex-col 2xl:px-36 ">
                ...
                <p style="padding:20px; color:white; text-align:center">© 2025 Spicy Travels n Tour Ltd. All Right Reserved 
        </footer>
    </section>
    </main>
</body>
