...
<!-- end header mobile  -->
   ...
   <section class="w-full flex justify-center mt-[180px]">
    <div class="w-[700px] md:w-[900px] container h-auto  ">
        ...
        <br>
        <br>
        <marquee direction="down" scrollamount="3">Here is wishing you a <span style="color:red;">Merry Christmas</span> and a <span style="color:purple;">Prosperous 2025</span>...</marquee>  
